...
class VisionAndValuesView(BaseModel):
    """## 公司是否具有清晰且共享的愿景及价值观？ [id:vision_and_values]"""
    team_recognition: Optional[str] = Field(
        None,
...
class TeamStructureAndCollaborationView(BaseModel):
    """## 团队构成是否完整？（主要了解团队是否完整，相互之间是否互补） [id:team_structure_and_collaboration]"""
...
class CoreCompetenciesView(BaseModel):
    """## 创始人及核心团队综合能力情况如何？ [id:core_competencies]"""
    team_collaboration: Optional[str] = Field(
        None,
        json_schema_extra={"markdown_title": "公司团队关系及协作是否融洽？"}
    )
    prior_collaboration_current_relationship: Optional[str] = Field(
        None,
        json_schema_extra={"markdown_title": "团队成员是否在创业之前有过协作经历？目前团队成员之间关系是否融洽？沟通是否顺畅？"}
    )
    technical_product_capability: Optional[str] = Field(
        None,
    ...
    zero_to_one_experience: Optional[str] = Field(
        None,
        json_schema_extra={"markdown_title": "创始人及核心团队成员是否有过从0到1构建产品的经历吗？"}
    )
    ...
    leadership_management: Optional[str] = Field(
        None,
    ...
    core_qualities: Optional[str] = Field(
        None,
...
class FounderMarketFitView(BaseModel):
    """## 创始人和市场契合情况如何？ [id:founder_market_fit]"""
...
class FounderPersonalTraitsView(BaseModel):
    """## 创始人核心品质如何？ [id:founder_personal_traits]"""
    ceo_fit: Optional[str] = Field(
        None,
    ...
    team_character: Optional[str] = Field(
        None,
    ...
    cognitive_judgment: Optional[str] = Field(
        None,
...
class LongTermPotentialView(BaseModel):
    ...
    talent_strategy: Optional[str] = Field(
        None,
    ...
    conflict_resolution_system: Optional[str] = Field(
        None,
...
# 公司创始人和团队 [id:company_founder_and_team]
...
""".strip()
    ...
    vision_and_values: VisionAndValuesView = Field(
        ...
        json_schema_extra={"markdown_title": "公司是否具有清晰且共享的愿景及价值观？"}
    )
