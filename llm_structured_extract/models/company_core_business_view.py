...
class CoreTechAndAdvantageView(BaseModel):
    """## 公司核心技术及优势是什么？ [id:core_tech_and_advantage]"""
...
class ProductionProcessView(BaseModel):
    """## 公司生产流程及工艺如何？（只分析制造类企业，服务类企业不询问） [id:production_process]"""
...
class SupplyChainAndCustomerView(BaseModel):
    """## 原材料供应商及客户结构情况如何？ [id:supply_chain_and_customer]"""
...
class BusinessStrategyAndPlanningView(BaseModel):
    """## 公司经营战略及未来规划如何？ [id:business_strategy_and_planning]"""
...
# 公司核心业务情况如何？ [id:company_core_business]
