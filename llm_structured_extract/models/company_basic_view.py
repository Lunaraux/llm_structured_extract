...
class EquityStructureView(BaseModel):
    """## 公司股权架构情况如何？（主要了解实控人及其他股东持股情况） [id:equity_structure]"""
...
class HistoricalMilestonesView(BaseModel):
    """## 公司历史沿革情况如何？ [id:historical_milestones]"""
...
class SubsidiariesAndAffiliatesView(BaseModel):
    """## 公司子公司及实控人关联公司情况如何？ [id:subsidiaries_and_affiliates]"""
    ...
    related_companies: Optional[str] = Field(
        None,
...
class HrConfigurationView(BaseModel):
    """## 公司人力资源情况如何？ [id:hr_configuration]"""
